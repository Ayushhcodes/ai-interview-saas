...
//                     <BsRobot size={18}/>
//                 </div>
//                 <h1 className="font-semibold hidden md:block">RecruitIQ.AI</h1>
//             </div>
...
function Navbar() {
    const {userData} = useSelector((state)=>state.user)   //userdata ko access karna
    const [showCreditPopup,setShowCreditPopup] = useState(false)   //credit ko click karenge toh kya hoga uska permission
    const [showUserPopup,setShowUserPopup] = useState(false)
    const navigate = useNavigate()      //navigate use krne ka permisiion
            ...
            <div className='flex items-center gap-6  relative'>
                ...
                <div className='relative'>
                    ...
                    onClick={()=>{
                        ...
                        setShowCreditPopup(false)         //taki jab ekclick kre toh dusra hatt jaye 
                    }} className='w-9 h-9 bg-black text-white rounded-full flex items-center justify-center font-semibold'>
                        {/* Check if userData exists; if so, show their first initial, otherwise show the astronaut icon */}
